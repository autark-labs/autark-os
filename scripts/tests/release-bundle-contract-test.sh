...
grep -q 'New managed-app updates are deferred for the controlled beta' "${bundle_dir}/docs/GETTING_STARTED.md"
grep -q '^# Autark-OS 1.2.3$' "${bundle_dir}/docs/RELEASE_NOTES.md"
grep -q '^## Known Limitations$' "${bundle_dir}/docs/RELEASE_NOTES.md"
grep -q 'New managed-app updates are deferred during the controlled beta' "${bundle_dir}/docs/RELEASE_NOTES.md"
