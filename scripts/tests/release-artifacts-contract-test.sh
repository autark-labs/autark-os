...
grep -q 'failed health or managed-app verification' "${control_dir}/postinst"
grep -q '/api/system/update-inventory/verify' "${control_dir}/postinst"
grep -q 'latest-inventory-report.json' "${control_dir}/postinst"
...
! grep -q 'deconfigure.*upgrade' "${control_dir}/prerm"
...
grep -q '/api/system/update-inventory' "${control_dir}/preinst"
grep -q 'managed-app-inventory.json' "${control_dir}/preinst"
grep -q 'identityFileSha256' "${control_dir}/preinst"
grep -q 'config/identity.json' "${control_dir}/preinst"
grep -q '/run/autark-os-package-upgrade-inventory' "${control_dir}/preinst"
grep -q '/run/autark-os-package-upgrade-inventory' "${control_dir}/postinst"
grep -q '/run/autark-os-package-upgrade-service-enabled' "${control_dir}/preinst"
grep -q '/run/autark-os-package-upgrade-service-enabled' "${control_dir}/postinst"
