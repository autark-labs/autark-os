...
host_setup_file="${repo_root}/frontend/src/pages/NetworkPage/HostSetupPanel.tsx"
...
grep -q "HostSetupPanel" "${network_file}"
grep -q "grants Tailscale Serve permission" "${host_setup_file}"
grep -q "Set up later" "${tailscale_setup_file}"
