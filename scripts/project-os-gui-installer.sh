...
BOOTSTRAP_SCRIPT="${SCRIPT_DIR}/bootstrap-project-os.sh"
...
All other options are passed to bootstrap-project-os.sh for shared doctor and
...
die() {
  printf '[project-os gui installer] error: %s\n' "$*" >&2
  exit 1
}
  ...
  cat <<JSON
{
  ...
  "packaging": {
    ...
    "launcher": "project-os-gui-installer.sh",
    "nativeShell": "later",
  ...
  "sharedOperations": [
    {
      ...
      "source": "bootstrap-project-os.sh --doctor --json",
      "mutatesHost": false,
    ...
    },
    {
      ...
      "source": "bootstrap-project-os.sh --plan --json",
      "mutatesHost": false,
      "requiresPrivilege": false
    },
    {
      ...
      "source": "bootstrap-project-os.sh --auto-install-deps",
      "mutatesHost": true,
  ...
  "logging": {
    ...
    "supportBundleHandoff": "project-os support-bundle --state-dir <state-dir> --output <path>"
  },
  "recoveryActions": [
    {
      "id": "retry",
    ...
    },
    {
      ...
      "source": "bootstrap-project-os.sh --state-dir"
    },
    {
      "id": "save-support-report",
      "label": "Save support report",
      "source": "project-os support-bundle --state-dir <state-dir> --installer-log <log> --output <path>"
    },
    {
...
recovery_command = "scripts/bootstrap-project-os.sh" + state_dir_arg + " [same choices]"
...
contract = {
    "deviceCheck": {
        ...
        "supportDetails": {
            ...
            "planJsonIncluded": True,
            "exactCommand": "bootstrap-project-os.sh --doctor --json",
        },
        "actions": [
    ...
    "storageChoice": {
        ...
        "supportDetails": {
            "planJsonIncluded": True,
            "exactCommand": "bootstrap-project-os.sh --plan --json",
        },
    },
    "capabilityChoices": {
        ...
        "advancedDetails": {
            ...
            "commands": [
                "bootstrap-project-os.sh --auto-install-deps",
                "bootstrap-project-os.sh --plan --json",
            ],
        },
        "planImpact": {
    ...
    "installProgress": {
        ...
        "supportReport": {
            ...
            "command": "project-os support-bundle --state-dir <state-dir> --installer-log <log> --output <path>",
