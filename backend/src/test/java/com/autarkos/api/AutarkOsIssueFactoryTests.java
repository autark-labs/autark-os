...
class AutarkOsIssueFactoryTests {

    @Test
    void createsActionableIssueWithConsistentShape() {
        AutarkOsAction action = AutarkOsAction.post("repair-vaultwarden", "Repair", "/api/apps/vaultwarden/repair", false, false);
    ...
    void createsRouteActionWithoutHttpMethod() {
        AutarkOsAction action = AutarkOsAction.route("open-discover", "Install an app", "/discover");
