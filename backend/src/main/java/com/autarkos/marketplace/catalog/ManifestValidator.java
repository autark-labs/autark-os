...
public class ManifestValidator {
    ...
    public void validate(ApplicationManifest manifest) {
        ...
        if (!manifest.runtime().runtimeRoot().isBlank() && !manifest.runtime().runtimeRoot().equals("/var/lib/autark-os/apps/" + manifest.id())) {
            errors.add("runtime.runtimeRoot must equal /var/lib/autark-os/apps/" + manifest.id());
        }
