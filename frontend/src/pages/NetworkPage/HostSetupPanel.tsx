    ...
    <NetworkPanel>
      ...
      <div className="grid gap-4">
        ...
        <NetworkInset className="p-3">
          ...
          <p className="mt-2 text-xs leading-5 text-sky-100/70">Run once on the Autark-OS host. It installs the root-run appliance service and prepares its runtime folders.</p>
        </NetworkInset>
      </div>
    </NetworkPanel>
  );
