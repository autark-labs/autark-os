      ...
      <DialogContent className="border-sky-400/30 bg-slate-900 text-slate-50 shadow-xl shadow-slate-950/30 sm:max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription className="leading-6 text-slate-400">
            Autark-OS already sees {appName} on your system. Installing another copy can cause confusing behavior across your network, especially from phones, TVs, or other devices that discover services automatically. Review recovery for the existing service when possible. Install a second copy only if you intentionally want two separate instances.
          </DialogDescription>
        </DialogHeader>
