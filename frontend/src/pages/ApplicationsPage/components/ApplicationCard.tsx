...
export function ApplicationCard({
  ...
  return (
    <Card
      ...
      className={cn(
        'relative h-[218px] w-[13rem] overflow-hidden rounded-xl border border-sky-300/20 bg-[#0b1831]/90 py-0 text-slate-50 shadow-lg shadow-slate-950/20 ring-0 transition duration-200',
        !managementOpen && 'cursor-pointer hover:-translate-y-0.5 hover:border-cyan-300/50 hover:bg-[#10213f] hover:shadow-xl hover:shadow-cyan-950/30',
    ...
    >
      ...
      <div className="pointer-events-none relative z-10">
        ...
        <div className="space-y-1 px-3 pb-3 pt-2">
          ...
          <p className="m-0 truncate text-xs text-slate-400">{item.managementState === 'linked' ? 'Linked service' : 'Managed app'}</p>
      ...
      {item.href ? (
        <a
          ...
          className="absolute bottom-3 right-9 z-20 inline-flex size-6 items-center justify-center rounded-md text-slate-300 transition hover:bg-white/10 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-300/80"
          href={item.href}
      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <button
            ...
            className="absolute bottom-3 right-2 z-20 inline-flex size-6 items-center justify-center rounded-md text-slate-400 transition hover:bg-white/10 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-300/80"
            disabled={managementOpen}
            onClick={(event) => event.stopPropagation()}
            type="button"
          >
