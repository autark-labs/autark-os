...
/** Replaces unavailable content; background refreshes use header context instead. */
  ...
  const content = (
    ...
    >
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        ...
        {onRetry && (
          <Button className="shrink-0 border-red-300/30 bg-slate-900 text-red-100 hover:bg-red-500/20" onClick={onRetry} size="sm" type="button" variant="outline">
