  ...
  const services: HeaderService[] = [
    {
      ...
      healthySummary: 'Docker is reachable and ready for Marketplace apps.',
      needsAttentionSummary: 'Docker is required before Project OS can install and run Marketplace apps.',
      check: dockerCheck,
      href: '/settings',
