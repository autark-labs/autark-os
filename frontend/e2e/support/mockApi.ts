...
const backupReport = {
  ...
  destination: {
    kind: 'internal',
    status: 'ready',
    configuredPath: '/var/lib/autark-os/backups',
    mountPoint: '/',
    deviceIdentity: 'fixture-runtime-disk',
    filesystemType: 'ext4',
    available: true,
    writable: true,
    usableBytes: 430_000_000_000,
    protectsAgainstRuntimeDriveFailure: false,
    message: 'Backups are stored on this server.',
    actionLabel: null,
    checkedAt: fixedAt,
  },
  apps: [{
...
const version = { version: '0.9.0-fixture', buildSha: 'fixture', buildDate: fixedAt, installPath: '/opt/autark-os', runtimePath: '/var/lib/autark-os', backendJar: '/opt/autark-os/autark-os.jar', checkedAt: fixedAt };
const settings = { deviceName: systemSummary.deviceName, timeZone: 'America/Chicago', language: 'en', temperatureUnit: 'fahrenheit', dateFormat: 'MMM d, yyyy', timeFormat: '12-hour', startOnBoot: true, telemetryEnabled: false, defaultInstallAccess: 'local-and-private', automaticRepairEnabled: true, automaticBackupsEnabled: true, backupFrequency: 'daily', backupRetentionDays: 14, backupTime: '03:00', showAdvancedMetrics: true, updatedAt: fixedAt };
