...
const settings = { deviceName: systemSummary.deviceName, timeZone: 'America/Chicago', language: 'en', temperatureUnit: 'fahrenheit', dateFormat: 'MMM d, yyyy', timeFormat: '12-hour', startOnBoot: true, telemetryEnabled: false, defaultInstallAccess: 'local-and-private', automaticRepairEnabled: true, automaticBackupsEnabled: true, backupFrequency: 'daily', backupRetentionDays: 14, backupTime: '03:00', updatedAt: fixedAt };
