...
const visualCases: VisualCase[] = [
  ...
  { name: 'backups-1440', path: '/backups', expected: /Backup timeline/i, viewport: { width: 1440, height: 1000 } },
  { name: 'backups-390', path: '/backups', expected: /Backup timeline/i, viewport: { width: 390, height: 844 } },
