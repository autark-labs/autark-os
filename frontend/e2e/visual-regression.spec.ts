...
const visualCases: VisualCase[] = [
  ...
  { name: 'settings-1280', path: '/settings', expected: /Appliance settings/i, viewport: { width: 1280, height: 960 } },
  { name: 'diagnostics-1024', path: '/diagnostics', expected: /^Diagnostics$/i, viewport: { width: 1024, height: 960 } },
];
