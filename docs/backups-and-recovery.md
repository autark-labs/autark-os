...
restore and recovery operations still create a fresh verified safety checkpoint
before data is replaced; an older restore point by itself does not bypass that
requirement.
